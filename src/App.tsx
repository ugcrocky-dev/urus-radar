      ...
      <div className="layout">
        ...
        <main className="main">
          ...
          <p className="footer-note">
            Data is a curated Sep 2026 snapshot from public dealer/aggregator
            pages. Asking prices change; always verify VIN, title, PPI, and
            import eligibility before sending money.
          </p>
        </main>
      </div>
    </div>
